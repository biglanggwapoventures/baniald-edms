...
class Treasurermodel extends CI_Model{
	...
	public function add_payment($id, $data){

		$data['request_status'] = 'paid';
		$data['date_paid'] =date_create_immutable(null)->format('Y-m-d H:i:s');
		return $this->db->update('requests_forms', $data, ['requests_forms_id' => $id]);
