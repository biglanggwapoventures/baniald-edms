                    ...
                    <?php foreach($view_history as $row): ?>
                        <tr>
                            ...
                            <?php if($row->request_status == 'pending'): ?>
                                ...
                                <td><button type="button" class="btn btn-warning btn-flat btn-sm" style="text-transform: uppercase;"> <?php echo $row->request_status; ?> &nbsp;&nbsp;<i class="fa fa-hourglass-o">    </i></button>
                                </td>
                            
                            <?php elseif($row->request_status == 'paid'): ?>
                                 <td><button type="button" class="btn btn-primary btn-flat btn-sm" style="text-transform: uppercase;"> <?php echo $row->request_status; ?> &nbsp;&nbsp;<i class="fa fa-check-square">    </i></button>
                                </td>
                            <?php else: ?>    
                            ...
                            <td><?php echo date("F d, Y h:i A", strtotime($row->requests_created)); ?></td>
                              <td><?php echo date(" h:i A", strtotime($row->date_cleared)); ?></td>
                        </tr> 
                    <?php endforeach; ?>
                </tbody>
            </table>
