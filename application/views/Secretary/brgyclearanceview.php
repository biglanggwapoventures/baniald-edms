                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="box-footer">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4"><p>Barangay Banilad</p></div>    
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4"><p>Cebu City</p></div>    
                                        </div>
                    ...
                    <div class="row padding-top-20">
                         <div class="col-md-12">
                            <form action="<?= base_url("secretary_listing/reviewed/{$this->uri->segment(3)}/{$this->uri->segment(4)}")?>" method="POST" onsubmit="return confirm('ARE YOU SURE? PLEASE CONFIRM.')">
                                ...
                                <a href="<?= base_url('secretary_listing/?form_id=1')  ?>" class="btn btn-primary btn-flat btn-lg pull-right"><i class="fa fa-arrow-circle-o-left fa-arrow-circle-o-left fa-lg"></i> <label>BACK</label></a>
                            </form>   
                         </div>
                    </div>
                <?php endif; ?>
